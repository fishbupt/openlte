...
#define LIBLTE_MME_EMM_CAUSE_SEVERE_NETWORK_FAILURE 0x2A
...
#define LIBLTE_MME_GPRS_TIMER_3_UNIT_2_SECONDS 0x3
#define LIBLTE_MME_GPRS_TIMER_3_UNIT_30_SECONDS 0x4
#define LIBLTE_MME_GPRS_TIMER_3_UNIT_1_MINUTE 0x5
#define LIBLTE_MME_GPRS_TIMER_3_UNIT_320_HOURS 0x6
...
// Enums
typedef enum {
  LIBLTE_MME_DATA_SERVICE_TYPE_MO_REQUEST = 0,
...
typedef enum {
  ...
  LIBLTE_MME_DDX_NO_FURTHER_DATA,
...
#define LIBLTE_MME_SECURITY_HDR_TYPE_INTEGRITY_AND_PARTIALLY_CIPHERED 0x5
